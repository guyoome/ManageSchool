...
public class bulletinDAO extends DAO<bulletin> {
    ...
    public boolean create(bulletin obj) {
        try {
            ...
            create.setObject(4, obj.getId_eleve());
    ...
    public ArrayList<bulletin> findAll() {
        ...
        try {
            ...
            while (result.next()) {
                ...
                id_eleve = result.getInt("id_eleve");
                bulletin newBulletin = new bulletin(id, appreciation, id_trimestre, id_inscription, id_eleve);
    ...
    public ArrayList<bulletin> rechercher(String parametreTable, String parametre) {
        ...
        try {
            ...
            while (result.next()) {
                b = new bulletin(result.getInt("id"), result.getString("appreciation"), result.getInt("id_trimestre"), result.getInt("id_inscription"), result.getInt("id_eleve"));
                bb.add(b);
            }
        } catch (SQLException e) {
            e.printStackTrace();
