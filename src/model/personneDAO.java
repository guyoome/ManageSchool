...
public class personneDAO extends DAO<personne> {
    ...
    public ArrayList<personne> findAll() {
        ...
        try {
            ...
            while (result.next()) {
                ...
                classe = result.getInt("id_classe");
                personne newBulletin = new personne(id, nom, prenom, type_, userP, mdp, classe);
    ...
    public ArrayList<personne> rechercher(String parametreTable, String parametre) {
        ...
        try {
            ...
            while (result.next()) {
                b = new personne(result.getInt("id"), result.getString("nom"), result.getString("prenom"), result.getString("type_"), result.getString("userP"), result.getString("mdp"), result.getInt("id_classe"));
                bb.add(b);
            }
        } catch (SQLException e) {
            e.printStackTrace();
